...
OPEN_QUESTIONS = {
    ...
    "penholder_cradle": dict(
        ...
        rides_on="63.3 mm of tip position.  At the gate-validated 0.110 m of "
                 ...
                 "the planner's ray needs 125.6 mm of graphite past the cap's "
                 "outer face and 23 deg needs 89.5 mm (130.6 / 94.5 measured "
                 "to the housing's own end face, which is 5.000 mm inside the "
                 "cap; the 10-deg assembly's own answer is 17.0).  NOTHING IS "
                 "CHANGED HERE: the "
