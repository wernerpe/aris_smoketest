...
OPEN_QUESTIONS = {
    ...
    "penholder_cradle": dict(
        ...
        why="THERE IS NO CRADLE, AND THERE IS NO FEATURE ON THE FAT FINGER "
            ...
            "manufacturer's own hand collision shell, the raw housing STL is "
            "INSIDE the hand at every lean below 35.17 deg: -11.90 mm at 23, "
            "-0.16 at 35, +6.16 at 45.  23 deg IS RULED OUT by the gripper "
            "it hangs from.",
        rides_on="HOW MUCH GRAPHITE.  The tool transform moved on "
                 "2026-09-03 (frames.PEN_EXT_HOLDER / PEN_LAT_HOLDER, both "
                 "0.0588421 m, USER-SPECIFIED from the photo: the tip ~5 cm "
