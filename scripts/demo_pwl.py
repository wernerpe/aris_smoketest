...
def demo_strokes():
    """The two strokes this demo and demo_smooth.py both run on.

    Kept here as the single construction so the smoothing/pacing demo cannot
    silently drift onto a different rim arc or a differently-placed R.
    """
    spec = FLEET[31]
    bx, by = spec.xy
    ...
    return spec, [("A_rim_arc", arcA, 0.012), ("R_bowl", bowlB, writing.DS)]
