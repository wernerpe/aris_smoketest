...
| Grip -> nose | **55.1 mm** (post axis crosses the bore 55.1 mm behind the nose) | tip is 155.6 mm from the TCP | **OPEN.** needs **100.5 mm** of ⌀7 graphite past the nose against **64.4 mm** at 23° (FINAL_RIG.md's older 25 mm grip-to-nose was the CAP end, not the nose) |
